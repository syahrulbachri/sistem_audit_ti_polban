...
<div class="card border-0 shadow-sm" style="border-radius: 12px; max-width: 600px;">
    <div class="card-body p-4">
        ...
        <form action="/admin/users/update/<?= $user->id ?>" method="post">
            ...
            <div class="mb-3">
                <label class="form-label fw-bold">Password Baru <span class="text-muted fw-normal">(Kosongkan jika tidak ingin mengubah)</span></label>
            ...
            <div class="mb-4">
                ...
                <select name="role" class="form-select" required>
                    ...
                    <option value="auditee" <?= old('role', $user->role) == 'auditee' ? 'selected' : '' ?>>Auditee</option>
