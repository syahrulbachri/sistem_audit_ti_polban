...
<div class="card border-0 shadow-sm" style="border-radius: 12px; max-width: 700px;">
    <div class="card-body p-4">
        ...
        <form action="/admin/periodes/store" method="post">
            <?= csrf_field() ?>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="nama_periode" class="form-control" value="<?= old('nama_periode') ?>" 
                       required placeholder="Contoh: Semester Genap 2026/2027">
            </div>

            <div class="mb-3">
                <label class="form-label fw-bold">Tahun </label>
                <input type="number" name="tahun" class="form-control" value="<?= old('tahun', date('Y')) ?>" 
                       required min="2020" max="2100" placeholder="Contoh: 2026">
                <small class="text-muted">Tahun bebas diisi (tidak harus tahun sekarang)</small>
            </div>
            ...
            <div class="alert alert-info">
                ...
                <strong>Info:</strong> Status default adalah <strong>Closed</strong>. Periode baru harus diaktifkan secara manual.
            </div>
